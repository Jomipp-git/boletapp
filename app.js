...
const TRANSLATIONS = Object.freeze({
  ...
  "Estimación orientativa, no una probabilidad estadística ni una identificación para consumo. Los umbrales se han contrastado con 1.218 avistamientos reales de GBIF en Cataluña (2010–2025) y la lluvia medida del Meteocat: nada de lo que se probó los mejoró, así que se mantienen. Aun así la lluvia reciente solo explica una parte de la fructificación: en años no usados para el ajuste, el modelo acierta aproximadamente la mitad de las brotadas reales.": "Estimació orientativa, no una probabilitat estadística ni una identificació per al consum. Els llindars s'han contrastat amb 1.218 albiraments reals de GBIF a Catalunya (2010–2025) i la pluja mesurada del Meteocat: res del que es va provar els va millorar, així que es mantenen. Tot i això la pluja recent només explica una part de la fructificació: en anys no fets servir per a l'ajust, el model encerta aproximadament la meitat de les brotades reals.",
