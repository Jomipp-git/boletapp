...
const MUSHROOMS = [
  ...
  },
  {
    ...
    temperature: { label: "Templada", minC: 12, maxC: 20, minExclusive: false },
    note: "Esta ficha se centra en B. edulis; el nombre popular también abarca otros boletos."
  },
  {
  ...
  },
  {
    ...
    temperature: { label: "Templada", minC: 12, maxC: 20, minExclusive: false }, note: "Ficha de un grupo de taxones con ecología variable."
  },
  {
  ...
  },
  {
    ...
    temperature: { label: "Calor", minC: 20, maxC: null, minExclusive: true }, note: "Requiere una media estrictamente superior a 20 °C."
  }
];
